...
var EmitterInstance = class {
  constructor(engine, emitters, container, options, position) {
    ...
    this._spawnDelay = getRangeValue((_a = this.options.life.delay) != null ? _a : 0) * 1e3 / this.container.retina.reduceFactor;
    ...
    if (this._duration !== void 0) {
      ...
      if (this._currentDuration >= this._duration) {
        ...
        if (this._lifeCount > 0 || this._immortal) {
          ...
          this._spawnDelay = getRangeValue((_c = this.options.life.delay) != null ? _c : 0) * 1e3 / this.container.retina.reduceFactor;
        } else {
          this._destroy();
        }
