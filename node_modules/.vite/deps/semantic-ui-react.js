...
var propertyIsEnumerable2 = objectProto9.propertyIsEnumerable;
...
function getFuncName(func) {
  var result = func.name + "", array = realNames_default[result], length = hasOwnProperty14.call(realNames_default, result) ? array.length : 0;
  while (length--) {
